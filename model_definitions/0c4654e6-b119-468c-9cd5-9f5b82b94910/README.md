...
After Feature engineering, the data is accessed via 2 views which contains the splits

- bank_features_train_v
- bank_features_test_v

Note that to validate scoring, we just use the test view. 
